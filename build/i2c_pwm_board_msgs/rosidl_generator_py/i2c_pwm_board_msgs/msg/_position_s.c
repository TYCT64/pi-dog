...
bool i2c_pwm_board_msgs__msg__position__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("i2c_pwm_board_msgs.msg._position.Position", full_classname_dest, 41) == 0);
  }
  i2c_pwm_board_msgs__msg__Position * ros_message = _ros_message;
  {  // servo
...
PyObject * i2c_pwm_board_msgs__msg__position__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("i2c_pwm_board_msgs.msg._position");
