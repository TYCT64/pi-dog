  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const i2c_pwm_board_msgs__msg__Servo * ros_message = static_cast<const i2c_pwm_board_msgs__msg__Servo *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_i2c_pwm_board_msgs__msg__Servo(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  i2c_pwm_board_msgs__msg__Servo * ros_message = static_cast<i2c_pwm_board_msgs__msg__Servo *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_i2c_pwm_board_msgs__msg__Servo(cdr, ros_message);
}
