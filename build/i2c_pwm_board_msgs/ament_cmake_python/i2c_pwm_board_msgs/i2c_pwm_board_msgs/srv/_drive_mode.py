...
class Metaclass_DriveMode_Event(type):
    """Metaclass of message 'DriveMode_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__drive_mode__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__drive_mode__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__drive_mode__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__drive_mode__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__drive_mode__event
...
class DriveMode_Event(metaclass=Metaclass_DriveMode_Event):
    """Message class 'DriveMode_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<i2c_pwm_board_msgs/DriveMode_Request, 1>',
        'response': 'sequence<i2c_pwm_board_msgs/DriveMode_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['i2c_pwm_board_msgs', 'srv'], 'DriveMode_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['i2c_pwm_board_msgs', 'srv'], 'DriveMode_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from i2c_pwm_board_msgs.srv import DriveMode_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, DriveMode_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'DriveMode_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from i2c_pwm_board_msgs.srv import DriveMode_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, DriveMode_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'DriveMode_Response'"
...
class Metaclass_DriveMode(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _drive_mode.Metaclass_DriveMode_Event._TYPE_SUPPORT is None:
                _drive_mode.Metaclass_DriveMode_Event.__import_type_support__()
...
class DriveMode(metaclass=Metaclass_DriveMode):
    ...
    from i2c_pwm_board_msgs.srv._drive_mode import DriveMode_Event as Event
