...
static const _ServosConfig_Event_type_support_symbol_names_t _ServosConfig_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, i2c_pwm_board_msgs, srv, ServosConfig_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, i2c_pwm_board_msgs, srv, ServosConfig_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, i2c_pwm_board_msgs, srv, ServosConfig_Event)() {
  return &::i2c_pwm_board_msgs::srv::rosidl_typesupport_c::ServosConfig_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t ServosConfig_service_type_support_handle = {
  ...
  &ServosConfig_Request_message_type_support_handle,
  &ServosConfig_Response_message_type_support_handle,
  &ServosConfig_Event_message_type_support_handle,
