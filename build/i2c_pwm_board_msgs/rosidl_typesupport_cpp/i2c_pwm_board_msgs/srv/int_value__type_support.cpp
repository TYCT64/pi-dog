...
static const _IntValue_Event_type_support_symbol_names_t _IntValue_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, i2c_pwm_board_msgs, srv, IntValue_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, i2c_pwm_board_msgs, srv, IntValue_Event)),
  }
};
...
{
  return &::i2c_pwm_board_msgs::srv::rosidl_typesupport_cpp::IntValue_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, i2c_pwm_board_msgs, srv, IntValue_Event)() {
  return get_message_type_support_handle<i2c_pwm_board_msgs::srv::IntValue_Event>();
}
...
static const rosidl_service_type_support_t IntValue_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<i2c_pwm_board_msgs::srv::IntValue_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<i2c_pwm_board_msgs::srv::IntValue_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<i2c_pwm_board_msgs::srv::IntValue_Event>(),
